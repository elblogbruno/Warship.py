...
update_id = None
chat_id = 415919768
##TELEGRAM_TOKEN = "729316731:AAEAoHTXtMSSbRAh38rBZW6y-O-H5vESoEk"
ReceivedMessage = ""
shouldGetImage = True
...
def main():
    ...
    updater = Updater(TELEGRAM_TOKEN, use_context=True,workers =10)
...
def send_image(imageFile):
            #command = 'curl -s -X POST https://api.telegram.org/bot' + TELEGRAM_TOKEN + '/sendPhoto -F chat_id=' + chat_id + " -F photo=@" + imageFile
